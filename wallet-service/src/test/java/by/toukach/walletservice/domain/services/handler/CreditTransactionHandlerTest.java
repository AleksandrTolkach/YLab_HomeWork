...
public class CreditTransactionHandlerTest extends BaseTest {
  ...
  public void handleTest_should_HandleTransaction() {
    ...
    TransactionDto actualTransactionResult = creditTransactionHandler.handle(transaction);
  ...
  public void handleTest_should_ThrowError_WhenAccountNotExist() {
    ...
    assertThrows(EntityNotFoundException.class, () -> creditTransactionHandler.handle(transaction));
  }
  ...
  public void handleTest_should_ThrowError_WhenTransactionExists() {
    ...
    assertThrows(EntityDuplicateException.class,
        () -> creditTransactionHandler.handle(transaction));
  }
  ...
  public void handleTest_should_ThrowError_WhenPresentsNegativeArgument() {
    ...
    assertThrows(ArgumentValueException.class, () -> creditTransactionHandler.handle(transaction));
  }
